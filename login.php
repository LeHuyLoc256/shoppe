                            ...
                            <div class="body__login">
                                ...
                                <div class="login__email">
                                    <div class="login__input">
                                        <input type="text" class="text" placeholder="Email/Số điện thoại/Tên đăng nhập" name="loginKey">
                                    </div>
                                    <div class="distance"></div>
                                </div>
                                <div class="login__password">
                                    <div class="login__input">
                                        <input type="password" class="text" placeholder="Mật khẩu" name="password">
                                    </div>
                                    <div class="distance"></div>
                                </div>
                                <button class="login__button">Đăng nhập</button>
